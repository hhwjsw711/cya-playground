...
const TASK_TYPE_OPTIONS = [
  ...
  { value: "security_compliance", label: "安全合规性保障" },
  { value: "consultation_assist", label: "咨询协助" },
  { value: "routine_inspection", label: "例行巡检" },
